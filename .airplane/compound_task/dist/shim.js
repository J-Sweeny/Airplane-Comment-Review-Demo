...
var require_fetcher = __commonJS({
  "node_modules/airplane/internal/api/fetcher.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.parseRetryAfter = exports.defaultRetryDelay = exports.HTTPError = exports.Fetcher = void 0;
    ...
    var Fetcher = class {
      ...
      async request(path, method, opts = {}) {
        ...
        url.pathname = path;
        url.search = opts.queryParams ? query_string_1.default.stringify(opts.queryParams) : "";
        let userAgent = `js-sdk/${package_json_1.default.version}`;
        if (this.teamID) {
          userAgent += " team/" + this.teamID;
        }
        if (this.runID) {
          userAgent += " run/" + this.runID;
        }
        const idempotencyKey = opts.idempotencyKey || (0, uuid_1.v4)();
        const headers = {
        ...
        const fetchOptions = {
          ...
          // Default to 10s.
          timeoutMs: (_a = opts.timeoutMs) !== null && _a !== void 0 ? _a : 1e4,
          retryDelay: (_b = this.retryDelay) !== null && _b !== void 0 ? _b : exports.defaultRetryDelay
        };
        if (opts.enableTracing) {
          const tracer = api_1.default.trace.getTracer("js-sdk", package_json_1.default.version);
          return await tracer.startActiveSpan(`fetcher.${method.toLowerCase()}`, async (span) => {
        ...
        return fetchWithRetries(fetchOptions);
      }
    };
    ...
    var fetchWithRetries = async (req) => {
      ...
      while (true) {
        ...
        if (attempt > 1) {
          ...
          await sleep(durationMs, controller);
          retryAfterMs = void 0;
        }
        ...
        try {
          const response = await (0, cross_fetch_1.default)(req.url, {
            ...
            headers: req.headers,
            body: req.body,
            // TODO: remove any cast once we drop support for node 14
          ...
          const canRetry = status === 429 || status >= 500 && status !== 501;
          if (!canRetry || attempt === maxAttempt) {
            throw await HTTPError.newFromResponse(req.method, response, attempt);
          }
          ...
          if (attempt === maxAttempt) {
            if (err.name === "AbortError" && !((_c = req.abortSignal) === null || _c === void 0 ? void 0 : _c.aborted)) {
              throw new HTTPError(`Request timed out after ${req.timeoutMs}ms.`, {
                method: req.method,
                url: req.url,
                statusCode: 500,
                attempt
    ...
    var sleep = async (until, controller) => {
  ...
  "node_modules/airplane/internal/api/client.js"(exports) {
    ...
    var Client = class {
      ...
      async createPrompt(prompt, opts = {}) {
        const resp = await this.fetcher.post("/v0/prompts/create", prompt, {
          abortSignal: opts.abortSignal,
          enableTracing: true,
          idempotencyKey: opts.idempotencyKey
        });
      ...
      async createSleep(sleep, opts = {}) {
        const resp = await this.fetcher.post("/v0/sleeps/create", sleep, {
          abortSignal: opts.abortSignal,
          enableTracing: true,
          idempotencyKey: opts.idempotencyKey
        });
...
var require_errors = __commonJS({
  "node_modules/airplane/internal/errors.js"(exports) {
    ...
    var RunTerminationError2 = class extends Error {
      constructor(run) {
    ...
    exports.RunTerminationError = RunTerminationError2;
  ...
  "node_modules/airplane/internal/runtime/dev.js"(exports) {
    ...
    exports.runtime = {
      ...
      sleep: async (duration) => {
        return standard_1.runtime.sleep(duration);
      },
      logChunks: (output) => {
...
var require_file = __commonJS({
  "node_modules/airplane/internal/file/file.js"(exports) {
    ...
    _a = AirplaneFile, _AirplaneFile_blob = /* @__PURE__ */ new WeakMap(), _AirplaneFile_instances = /* @__PURE__ */ new WeakSet(), _AirplaneFile_download = /**
     * Downloads the contents of this file, if not already downloaded.
     *
     ...
     */
    async function _AirplaneFile_download2() {
...
var require_params_serialized = __commonJS({
  "node_modules/airplane/internal/params/params_serialized.js"(exports) {
    ...
    var ts_dedent_1 = __importDefault(require_dist2());
  ...
  "node_modules/airplane/internal/config.js"(exports) {
    ...
    var dedentConfig = (config) => {
      const parameters = config.parameters ? Object.fromEntries(Object.entries(config.parameters).map(([slug, param]) => {
        ...
        return [
          slug,
          { ...param, description: param.description ? (0, ts_dedent_1.dedent)(param.description) : void 0 }
        ];
      })) : void 0;
      return {
        ...config,
    ...
    var optionsToSchema = (name, type, opts) => {
      ...
      const options = (_a = opts.options) === null || _a === void 0 ? void 0 : _a.map((opt) => {
        if (isLabeledOption(opt)) {
          return { ...opt, value: (0, params_serialized_1.serializeParamValue)(opt.value) };
        }
...
var require_sleep = __commonJS({
  "node_modules/airplane/internal/sleep/index.js"(exports) {
    ...
    var ms_1 = __importDefault(require_dist3());
    var runtime_1 = require_runtime();
...
// .airplane/compound_task/shim.js
var import_airplane2 = __toESM(require_airplane());

// tasks/compoound_task.airplane.js
var import_airplane = __toESM(require_airplane());
var compoound_task_airplane_default = import_airplane.default.task(
  {
    slug: "compound_task",
    name: "Compound Task",
    description: "This task pulls the list of comments from the produciton database then pulls the list of moderators from Airtable and a assigns a moderator to each comment in the order they were received.",
    parameters: {
      selected_mod: {
        type: "shorttext",
        name: "Selected Mod",
  ...
  async (params) => {
    ...
    try {
      ...
      const run = await import_airplane.default.execute(taskSlug);
      const secondTaskSlug = "airtable_get_employees";
      const run2 = await import_airplane.default.execute(secondTaskSlug);
...
async function main() {
  ...
  try {
    var ret;
    if ("__airplane" in compoound_task_airplane_default) {
      ret = await compoound_task_airplane_default.__airplane.baseFunc(JSON.parse(process.argv[2]));
    } else {
      ret = await compoound_task_airplane_default(JSON.parse(process.argv[2]));
    }
    if (ret !== void 0) {
      import_airplane2.default.setOutput(ret);
    }
  } catch (err) {
    console.error(err);
